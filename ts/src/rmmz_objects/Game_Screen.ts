...
class Game_Screen {
    ...
    startTint(tone: any, duration: number) {
    ...
    startFlash(color: any, duration: number) {
    ...
    // prettier-ignore
    showPicture(
        pictureId: number, name: string, origin: Point, x: number, y: number, scaleX: number, scaleY: number, opacity: number, blendMode: number
    ) {
        const realPictureId = this.realPictureId(pictureId);
    ...
    // prettier-ignore
    movePicture(
        pictureId: number, origin: Point, x: number, y: number, scaleX: number, scaleY: number, opacity: number, blendMode: number, duration: number,
        easingType: any
    ) {
    ...
    tintPicture(pictureId: number, tone: any, duration: any) {
        const picture = this.picture(pictureId);
        if (picture) {
