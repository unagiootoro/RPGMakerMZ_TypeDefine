...
class ColorManager {
    ...
    static hpColor(actor: Game_Battler | null) {
        if (!actor) {
    ...
    static mpColor(actor: Game_Battler | null) {
        return this.normalColor();
    }

    static tpColor(actor: Game_Battler | null) {
        return this.normalColor();
    }

    static paramchangeTextColor(change: number) {
        if (change > 0) {
